...
export class Configuration {
    ...
    constructor(param: ConfigurationParameters = {}) {
        ...
        if (this.apiKey === undefined) {
            this.apiKey = {}
            if (param.adminSecret !== undefined)
                this.apiKey["adminSecret"] = param.adminSecret
            if (param.apiKey !== undefined)
                this.apiKey["apiKey"] = param.apiKey
            if (param.apiUser !== undefined)
                this.apiKey["apiUser"] = param.apiUser
            if (param.userVersion !== undefined)
                this.apiKey["userVersion"] = param.userVersion
        }

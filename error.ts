...
/**
 * This class provides a wrapper for network errors when making requests to Coinprofile business API
 */
export class PartnaError extends Error {
  /**
   * The response body
   */
